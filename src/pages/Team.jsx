...
const team = [
  { name: 'Alex', image: assets.headshots.alex },
  { name: 'Jarrett', image: assets.headshots.jarrett },
  { name: 'Keith', image: assets.headshots.keith },
  { name: 'Wanemi', image: assets.headshots.wanemi },
  { name: 'Will', image: assets.headshots.will },
  { name: 'Kianna', image: assets.headshots.kianna },
  { name: 'Georgia', image: assets.headshots.georgia },
]
        ...
        <div className="mx-auto w-full max-w-2xl shrink-0 lg:mx-0 lg:flex lg:min-h-0">
          <div className="relative w-full overflow-hidden rounded-ui border border-border shadow-lg lg:h-full lg:min-h-0">
            <img
              ...
              alt="Gamebreakers team group photo"
      ...
      <section className="mt-12 sm:mt-16">
        ...
        <div className="mx-auto mt-8 grid max-w-5xl grid-cols-1 justify-items-center gap-8 md:grid-cols-3 lg:grid-cols-4">
          {team.map(({ name, image }) => (
            ...
            >
              <div className="aspect-square w-full shrink-0 overflow-hidden bg-border">
                <img
                  src={image}
                  alt={`${name} headshot`}
